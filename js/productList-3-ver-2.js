const runGsapAnimation = () => {
  ...
  if (window.innerWidth > 768) {
    document.fonts.ready.then(() => {
      ...
      //   // mask: "lines",
      // });
      // let bannerTitle_1 = document.querySelector(".title-1");
      // let bannerTitle_2 = document.querySelector(".title-2");

      const bannerTl = gsap.timeline();

      const textBanner = document.querySelectorAll(".xo-marquee-hide");
      bannerTl.fromTo(
        textBanner,
        {
          opacity: 0,
      ...
      // bannerTl.set(textBanner, { opacity: 1 });
      ...
      // Filter product
      const product_clip_1 = document.querySelector("#product-clip-1");
      const product_clip_2 = document.querySelector("#product-clip-2");
