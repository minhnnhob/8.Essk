const runGsapAnimation = () => {
  ...
  if (window.innerWidth > 768) {
    document.fonts.ready.then(() => {
      ...
      const subTitle = new SplitText(".our-banner__sub-title", {
        types: "lines ,words, chars",
        tagName: "span",
        // mask: "lines",
      });

      const title = new SplitText(".our-banner__title", {
        types: "lines ,words, chars",
        tagName: "span",
        // mask: "lines",
      });
      ...
      const sec2Title = new SplitText(".blog-content__title", {
        types: "lines ,words, chars",
        tagName: "span",
       
      });

      console.log(sec2Title)
      ...
      const sec2Filter = document.querySelectorAll(
        ".blog-content__filter-item"
      );

      sec2Filter.forEach((item) => {
        const icon = item.querySelector(".blog-content__filter-item-icon");
        const text = item.querySelector(".blog-content__filter-item-content");
        const txtSplit = new SplitText(text, {
          types: "lines ,words, chars",
          tagName: "span",
          // mask: "lines",
        });
      ...
      const sec2ImageBlg = document.querySelectorAll(
        ".blog-content-article__item"
      );

      sec2ImageBlg.forEach((item) => {
        const blogImg = item.querySelector(".blog-content-article__image");
        const blogText = item.querySelector(".blog-content-article__title");
        sec2Tl.from(
          blogImg,
          {
            opacity: 0,
