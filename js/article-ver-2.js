const runGsapAnimation = () => {
  ...
  if (window.innerWidth > 768) {
    document.fonts.ready.then(() => {
      ...
      const sec1Title = new SplitText(".article-top-content__title", {
      ...
      const sec1Icon = document.querySelectorAll(
        ".article-top-content__icon-item"
      );
      ...
      const sec1Imge = document.querySelector(".article-banner__img");

      sec1Tl.from(sec1Imge, {
        // opacity:0,
        filter: "blur(40px)",
        y: "80%",
        duration: 0.6,
